...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{route('dashboard')}}" class="logo">
      ...
      <span class="logo-lg"><b>Amwal </b>Dashboard</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset(auth()->user()->image? auth()->user()->image :'dist/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{auth()->user()->name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{ asset(auth()->user()->image? auth()->user()->image :'dist/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('users.index')}}"><i class="fa fa-circle-o"></i> Admins</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Admins groups</a></li>
          </ul>
        </li>
        <!-- <li class="treeview">
          <a href="#">
        ...
        <li>
          <a href="#">
            <i class="fa  fa-gg"></i> <span>Companies services</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"></small>
            </span>
          </a>
        ...
        <li>
          <a href="{{route('devices.index')}}">
            <i class="fa fa-fax"></i> <span>POS</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"></small>
            </span>
          </a>
        ...
        <li>
          <a href="{{route('balances.index')}}">
            <i class="fa fa-money"></i> <span>Charge balance</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"></small>
            </span>
          </a>
        ...
        <li>
          <a href="{{route('locations.index')}}">
            <i class="fa fa-map-o"></i> <span>Locations</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"></small>
            </span>
          </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020-2021 <a href="https://www.amwal-co.com/">Amwal Company</a>.</strong> All rights
    reserved.
  </footer>
