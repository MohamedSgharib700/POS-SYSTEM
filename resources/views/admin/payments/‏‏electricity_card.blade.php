...
<body>
    <section class="pos-holder">
        <div class="container  content-container">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" type="get"  action="{{route('electricity_card')}}">
             ...
             @if( count([$card]) > 0 && isset($_GET['number']))

                <div class="box-body no-padding">
                 <div class="mailbox-read-info  text-right">
                   @foreach($card as $card)
                   <h3>{{$card->name}} :   اسم العميل </h3>
                     <h3>{{$card->user_service_number}} :   رقم الكارت </h3> 
                     <a href="{{route('show_card', $card->id)}}"><h3> شحن الكارت </h3></a>
