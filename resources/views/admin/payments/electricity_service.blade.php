                                ...
                                <div class="row text-center">
                                    <div class="col-md-6">
                                        <div class="option py-3">
                                            <a href="{{route('electricity_card')}}">
                                                <img src="{{asset('pos/images/ll62.png')}}" class="img-fluid">
                                            </a>
                                        </div>
                                    </div>
                                    <!----->
                                    <div class="col-md-6 ">
                                        <div class="option py-3">
                                            <a href="{{route('electricity_bill',$device->id)}}">
                                                <img src="{{asset('pos/images/unnamed.jpg')}}" class="img-fluid">
                                            </a>
                                        </div>
                                    </div>
                                    <!---->
