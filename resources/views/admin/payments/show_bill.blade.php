    ...
    <section class="pos-holder">
        <div class="container  content-container">
                        ...
                        <div class="main-screen">
                            ...
                            <div class="container contetnt-holder py-4">
                              ...
                              <div class="text-center">
                                <h3 class="box-title">بيانات الفتورة</h3>
                             </div>
                             </br>
                             <!-- </br>
                             </br> -->
            ...
            @if(session()->has('success'))
              ...
              <form role="form" action="{{route('bill_payment' , $counter->id )}}" method="post"> 
                @csrf
                <div class="box-body no-padding">
                 <div class="mailbox-read-info  text-right">
                     <h3>{{$counter->name}} :   اسم العميل </h3>
                     <h5>رقم العداد  :  {{$counter->user_service_number}}</h5>
                     @if($counter->status == 1)
                     <h5>القيمة المستحقة : {{$counter->value}}</h5>
                     @else
                    ...
                    @if($counter->status == 1)
                       ...
                       <input type="hidden" class="form-control text-right"  name="status" value="0">
                       <input type="hidden" class="form-control text-right"  name="category_id" value="2">
                       <input type="hidden" class="form-control text-right"  name="pos_id" value="{{$device->id}}">
